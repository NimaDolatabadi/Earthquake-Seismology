...
c
c seisan changes:
c   delaz renamed to delaz_velest, does not seem to be used
c
...
c
c
      subroutine delaz_velest(alat,alon,blat,blon,del,dist,az)
c
...
c
c      subroutine DATETIME(dattim)       ! Urs Kradolfer, 16.9.91
c
...
c
c      implicit none
c      character datum*26, dattim*20
c      integer it, itime, ctime, time
c      external ctime !$pragma C(ctime)
c      external sprintf !$pragma C(sprintf)
c      external time !$pragma C(time)
c
c      it=time(itime)
c      it=ctime(itime)
c      call sprintf(datum,'%s',%val(it))
c      dattim=datum(5:24)
c
c      end ! of subroutine datetime
c
