...
c
      call nor2simulps(2,n+1,nrecord,nhead,data,stations,sta_list_count)
      n=n+1
      goto 10
c
 99   continue
...
c
c
      subroutine nor2simulps(unit,nevent,nrecord,nhead,data,stations,
     1     sta_list_count)
